...
client = OpenAI(
    ...
    api_key='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'
)

assistant_id = 'asst_x7Yczc07pp7Hzm9HMaxiQ7N1'
...
def send_prompt(thread_id):
    ...
    message = client.beta.threads.messages.create(
        ...
        content=prompt + "Responda em HTML e deixe o texto limpo"
    )
...
def analyze_file():
    ...
    print('Response Message:' + response_messages)
